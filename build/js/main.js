...
function newTabPageMain () {
  ...
  function enableLinkEditing () {
    customLinksUl.classList.add('is-editing');
    appendNewLinkField();
  }

  function disableLinkEditing () {
    customLinksUl.classList.remove('is-editing');
    customLinksUl.removeChild(document.getElementById('new-link'));
  }

  function appendNewLinkField () {
    customLinksUl.appendChild(document.getElementById('new-link-template').content.cloneNode(true));
  ...
  function addNewLink(link) {
    ...
    customLinksUl.insertBefore(newItem, document.getElementById('new-link'));
  }
